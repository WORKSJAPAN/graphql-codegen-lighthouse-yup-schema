...
export declare const buildApi: (fieldName: string, rules: Rules, ignoreRules: readonly string[], directives: readonly ConstDirectiveNode[]) => GeneratedCodesForDirectives;
export {};
