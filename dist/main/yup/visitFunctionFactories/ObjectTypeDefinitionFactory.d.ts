...
export declare class ObjectTypeDefinitionFactory implements VisitFunctionFactory<ObjectTypeDefinitionNode> {
    ...
    constructor(registry: Registry, visitor: Visitor, withObjectTypesSpec: WithObjectTypesSpec, exportTypeStrategy: ExportTypeStrategy, shapeRenderer: ShapeRenderer);
