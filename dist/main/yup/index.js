...
const generateFieldYupSchema = (config, visitor, field, indentCount) => {
    var _a, _b, _c;
    const generatedCodesForDirectives = (0, directive_1.buildApi)((_a = config.rules) !== null && _a !== void 0 ? _a : {}, (_b = config.ignoreRules) !== null && _b !== void 0 ? _b : [], (_c = field.directives) !== null && _c !== void 0 ? _c : []);
...
const generateFieldTypeYupSchema = (config, visitor, type, parentType, generatedCodesForDirectives) => {
    ...
    if ((0, graphql_1.isListType)(type)) {
        ...
        return `yup.array(${maybeLazy(config, type.type, gen)})${generatedCodesForDirectives.rulesForArray}.defined()${nullable ? '.nullable()' : ''}`;
    }
