...
class RuleASTFactory {
    ...
    helper(fieldName, ruleStrings) {
        ...
        const compositeRule = new RuleASTCompositeNode_1.RuleASTCompositeNode(others.map(({ name, rawArgs }) => new RuleASTSingleNode_1.RuleASTSingleNode(name, rawArgs)));
        return sometimesIfExists.length === 0 ? compositeRule : new RuleASTSometimesNode_1.RuleASTSometimesNode(fieldName, compositeRule);
    }
