...
exports.isSpecifiedScalarName = exports.isGeneratedByIntrospection = exports.topsort = exports.topologicalSortAST = exports.ObjectTypeDefinitionBuilder = exports.isInput = exports.isNamedType = exports.isNonNullType = exports.isListType = void 0;
...
const ObjectTypeDefinitionBuilder = (useObjectTypes, callback) => {
    if (!useObjectTypes)
        return undefined;
    return node => {
        if (useObjectTypes === 'no-reserved' && /^(Query|Mutation|Subscription)$/.test(node.name.value)) {
            return;
        }
...
const isSpecifiedScalarName = (scalarName) => graphql_1.specifiedScalarTypes.some(({ name }) => name === scalarName);
exports.isSpecifiedScalarName = isSpecifiedScalarName;
