...
const buildApi = (fieldName, rules, ignoreRules, directives) => {
    var _a;
    const ret = {
        rules: '',
        rulesForArray: '',
    ...
    for (const directive of directives) {
        if (isSupportedDirective(directive.name.value)) {
            ret[directive.name.value] = buildApiFromDirectiveArguments(fieldName, rules, ignoreRules, (_a = directive.arguments) !== null && _a !== void 0 ? _a : []);
        }
    }
    return ret;
};
