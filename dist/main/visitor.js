...
class Visitor extends typescript_1.TsVisitor {
    ...
    getScalarType(scalarName, scalarDirection) {
        return this.scalars[scalarName][scalarDirection];
    }
    shouldEmitAsNotAllowEmptyString(name, scalarDirection) {
        var _a;
        if (this.pluginConfig.notAllowEmptyString !== true) {
            return false;
        }
        const typ = this.getType(name);
        if (((_a = typ === null || typ === void 0 ? void 0 : typ.astNode) === null || _a === void 0 ? void 0 : _a.kind) !== 'ScalarTypeDefinition' && !(0, graphql_1.isSpecifiedScalarName)(name)) {
            return false;
        }
