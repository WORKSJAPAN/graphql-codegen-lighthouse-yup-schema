...
import { isSpecifiedScalarType, specifiedScalarTypes, visit, } from 'graphql';
...
export const isSpecifiedScalarName = (scalarName) => specifiedScalarTypes.some(({ name }) => name === scalarName);
